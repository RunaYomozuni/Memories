<footer>
    <div class="ap5">
        <div class="ap1">
            ...
            <div class="logo-sm">
                ...
                <a href="facebook.com">
                    <div class="logo"><i class="fa-brands fa-facebook" style="color: #fafcff;"></i></div>
                </a>
                <a href="twitter.com">
                    <div class="logo"><i class="fa-brands fa-x-twitter" style="color: #fafcff;"></i></div>
                </a>
                <a href="google.com">
                    <div class="logo"><i class="fa-brands fa-google-plus" style="color: #fafcff;"></i></div>
                </a>
                <a href="pinterest.com">
                    <div class="logo"><i class="fa-brands fa-pinterest" style="color: #fafcff;"></i></div>
                </a>
                <a href="instagram.com">
                    <div class="logo"><i class="fa-brands fa-instagram" style="color: #fafcff;"></i></div>
                </a>
            </div>
        </div>
    ...
    <div id="contentDeepFooter">
        ...
        <a href="#top">
            <div id="onTop"><i class="fa-solid fa-chevron-up" style="padding-top: 7px;"></i></div>
        </a>
    </div>
</footer>